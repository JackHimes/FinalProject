...
START TRANSACTION;
USE `rollthedicedb`;
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `profile_picture_url`, `enabled`, `role`) VALUES (1, 'admin', 'admin', 'Lavender', 'Cupcake', NULL, NULL, 1, 'ROLE_ADMIN');
